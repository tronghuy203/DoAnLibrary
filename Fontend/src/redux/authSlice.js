...
const authSlice = createSlice({
  ...
  reducers: {
    ...
    resendResetCodeStart: (state) => {
      state.resendResetCode.isFetching = true;
    },
    resendResetCodeSuccess: (state) => {
      state.resendResetCode.isFetching = false;
      state.resendResetCode.success = true;
      state.resendResetCode.error = false;
    },
    resendResetCodeFailed: (state) => {
      state.resendResetCode.isFetching = false;
      state.resendResetCode.success = false;
      state.resendResetCode.error = true;
    },
