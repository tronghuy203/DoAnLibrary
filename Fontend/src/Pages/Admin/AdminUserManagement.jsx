    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gradient-to-br dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 text-gray-900 dark:text-gray-100 py-12 px-4 sm:px-6 lg:px-8 transition-all duration-300 ease-in-out">
      <div className="max-w-5xl mx-auto">
        <div className="flex justify-between items-center mb-10">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-cyan-500 dark:text-cyan-400 tracking-wide drop-shadow-md animate-fade-in-up">
            Quản Lý Người Dùng
          </h2>
        </div>
        ...
        {editUserId && (
          <form
            ...
            className="w-full max-w-md mx-auto bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md mb-12 border border-gray-200 dark:border-gray-700/50 animate-slide-in transition-all duration-300 ease-in-out"
          >
            <div className="mb-5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 dark:focus:ring-cyan-400 transition-all duration-200 hover:border-cyan-500/50 dark:hover:border-cyan-400/50"
                />
              </div>
            </div>
            ...
            <div className="mb-5 flex items-center gap-3">
              <label className="flex items-center text-gray-700 dark:text-gray-300 text-sm font-semibold cursor-pointer">
                <input
                  type="checkbox"
                  checked={formData.admin}
                  onChange={(e) => setFormData({ ...formData, admin: e.target.checked })}
                  className="mr-2 h-4 w-4 text-cyan-500 dark:text-cyan-400 focus:ring-cyan-500 dark:focus:ring-cyan-400 border-gray-300 dark:border-gray-600 rounded cursor-pointer"
                />
                Vai trò Admin
              </label>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-cyan-500 dark:bg-cyan-400 hover:bg-cyan-600 dark:hover:bg-cyan-500 text-white font-semibold py-2 rounded-lg transition-all duration-200 hover:shadow-md"
            >
              Cập nhật
            </button>
          </form>
        ...
        {userList?.length > 0 ? (
          <>
            <div className="w-full bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700/50 overflow-hidden transition-all duration-300 ease-in-out">
              <div className="hidden sm:grid sm:grid-cols-[1fr_1fr_1.5fr_1fr_1fr] bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-200 font-semibold p-4">
              ...
              <div className="divide-y divide-gray-200 dark:divide-gray-700">
                {currentUsers.map((u) => (
                  <div
                    key={u._id}
                    className="flex flex-col sm:grid sm:grid-cols-[1fr_1fr_1.5fr_1fr_1fr] p-4 hover:bg-gray-50 dark:hover:bg-gray-750 hover:-translate-y-1 transition-all duration-300 animate-slide-in"
                  >
          ...
          <div className="text-center text-gray-500 dark:text-gray-400 py-10 animate-slide-in text-lg sm:text-xl transition-all duration-300 ease-in-out">
