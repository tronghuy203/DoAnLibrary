                ...
                >
                  ...
                  <div className="flex gap-4">
                    <button
                      ...
                      className="flex-1 px-4 py-2 bg-gradient-to-r from-green-500 to-teal-600 text-white font-medium rounded-lg shadow-md hover:from-green-600 hover:to-teal-700 transform hover:scale-105 transition-all duration-300"
                    >
                      Phê duyệt
                    </button>
                    <button
                      onClick={() => handleReject(doc._id)}
                      className="flex-1 px-4 py-2 bg-gradient-to-r from-red-500 to-pink-600 text-white font-medium rounded-lg shadow-md hover:from-red-600 hover:to-pink-700 transform hover:scale-105 transition-all duration-300"
                    >
                      Từ chối
                    </button>
                  </div>
                  <button
                    ...
                    className="w-full mt-4 px-4 py-2 bg-gradient-to-r from-teal-500 to-cyan-600 text-white font-medium rounded-lg shadow-md hover:from-teal-600 hover:to-cyan-700 transform hover:scale-105 transition-all duration-300"
                  >
                    Xem chi tiết
                  </button>
                </div>
